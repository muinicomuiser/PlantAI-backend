...
export class ProductoSalidaDto {
    @ApiProperty({example: 1, description: 'Generado automáticamente en el servidor.'})
    ...
    @ApiProperty({example: 5, description: 'Puntuación en escala numérica que los usuarios le han dado al producto.'})
    puntuacion: number;
