...
const pago_enum_1 = require("../../pedidos/entities/pago.enum");
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Devuelve todos los usuarios', type: output_userDTO_1.OutputUserDTO
    }),
    (0, swagger_1.ApiResponse)({
        status: 404,
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Usuario encontrado', type: output_userDTO_1.OutputUserDTO
    }),
    (0, swagger_1.ApiResponse)({
        status: 404,
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Devuelve la lista de pedidos de un usuario', type: output_pedido_dto_1.OutputPedidoDto
    }),
    (0, swagger_1.ApiResponse)({
        status: 404,
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'Tipo de Pago', enum: pago_enum_1.tipoPago }),
