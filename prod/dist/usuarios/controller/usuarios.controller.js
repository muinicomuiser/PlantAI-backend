...
__decorate(
  [
    (0, swagger_1.ApiOperation)({
      summary: 'Actualiza el carro de un usuario',
    }),
    (0, swagger_1.ApiResponse)({
      status: 201,
    ...
    __metadata('design:paramtypes', [
      Number,
      update_carro_compra_dto_1.UpdateCarroCompraDto,
    ]),
    __metadata('design:returntype', void 0),
  ],
  UsuariosController.prototype,
...
__decorate(
  [
    ...
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [
      create_pedido_dto_1.CreatePedidoDto,
      Number,
    ]),
    __metadata('design:returntype', void 0),
  ],
...
__decorate(
  [
    (0, swagger_1.ApiOperation)({
      summary: 'Obtiene los pedidos realizados según usuario',
    }),
    (0, swagger_1.ApiResponse)({
      status: 200,
...
__decorate(
  [
    (0, swagger_1.ApiOperation)({
      summary: 'Modifica el medio de pago de un usuario',
    }),
    (0, swagger_1.ApiResponse)({
      status: 201,
