...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Obtener toda la información del equipo' }),
    (0, common_1.Get)(),
    __param(0, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], EquipoController.prototype, "obtenerEquipo", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Obtener área por nombre' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Devuelve información del área' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'No existe un area con ese nombre' }),
    ...
    __metadata("design:returntype", void 0)
], EquipoController.prototype, "obtenerEquipoPorArea", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], EquipoController.prototype, "obtenerAreas", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Obtener información del ecommerce' }),
    (0, common_1.Get)('plantai'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], EquipoController.prototype, "obtenerInformacionGeneral", null);
