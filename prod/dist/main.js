...
async function bootstrap() {
    ...
    const documentCarro = swagger_1.SwaggerModule.createDocument(app, configCarro, {
        include: [carro_compras_module_1.CarroComprasModule],
    });
    const documentCatalogo = swagger_1.SwaggerModule.createDocument(app, configCatalogo, {
        include: [catalogo_module_1.CatalogoModule],
    });
    const documentPedidos = swagger_1.SwaggerModule.createDocument(app, configPedidos, {
        include: [pedidos_module_1.PedidosModule],
    });
    const documentProductos = swagger_1.SwaggerModule.createDocument(app, configProductos, {
        include: [productos_module_1.ProductosModule],
    });
    const documentUsuarios = swagger_1.SwaggerModule.createDocument(app, configUsuarios, {
        include: [usuarios_module_1.UsuariosModule],
    });
    const documentEquipo = swagger_1.SwaggerModule.createDocument(app, configEquipo, {
