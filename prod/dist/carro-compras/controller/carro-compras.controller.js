...
__decorate(
  [
    ...
    (0, swagger_1.ApiResponse)({
      status: 400,
      description: 'Error al crear carro',
    }),
    (0, common_1.Post)(),
  ...
  CarroComprasController.prototype,
  'createCarro',
  null,
);
__decorate(
  [
    (0, swagger_1.ApiOperation)({
      summary: 'Busca un carro de compras por id',
    }),
    (0, swagger_1.ApiResponse)({
      status: 200,
...
__decorate(
  [
    (0, swagger_1.ApiOperation)({
      summary: 'Busca un carro de compras por id de usuario',
    }),
    (0, swagger_1.ApiResponse)({
      status: 200,
      description: 'Carro encontrado',
...
exports.CarroComprasController = CarroComprasController = __decorate(
  [
    ...
    __metadata('design:paramtypes', [
      carro_compras_service_1.CarroComprasService,
    ]),
  ],
